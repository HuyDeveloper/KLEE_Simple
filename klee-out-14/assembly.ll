...
27:                                               ; preds = %15
  ...
  %29 = call i32 @fclose(%struct._IO_FILE* noundef %28), !dbg !132
  store i32 0, i32* %1, align 4, !dbg !133
  br label %30, !dbg !133

30:                                               ; preds = %27, %12
  %31 = load i32, i32* %1, align 4, !dbg !134
  ret i32 %31, !dbg !134
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "ef4295ec269c734088711e6747af3ef8")
...
!131 = !DILocation(line: 28, column: 12, scope: !31)
!132 = !DILocation(line: 28, column: 5, scope: !31)
!133 = !DILocation(line: 29, column: 5, scope: !31)
!134 = !DILocation(line: 30, column: 1, scope: !31)
