...
define dso_local i32 @main() #0 !dbg !273 {
  ...
  %8 = bitcast i32* %3 to i8*, !dbg !287
  call void @saveFile(i8* noundef %8, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.13, i64 0, i64 0)), !dbg !288
  ret i32 0, !dbg !289
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "9229087180d08d960abdeef99b037af0")
!2 = !{!3, !4, !6, !8, !10}
