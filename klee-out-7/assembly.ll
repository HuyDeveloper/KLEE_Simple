...
define dso_local i32 @main() #0 !dbg !32 {
  ...
  %5 = bitcast i32* %2 to i8*, !dbg !37
  call void @klee_make_symbolic(i8* noundef %5, i64 noundef 4, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !38
  call void @llvm.dbg.declare(metadata i32* %3, metadata !39, metadata !DIExpression()), !dbg !40
  %6 = load i32, i32* %2, align 4, !dbg !41
  %7 = call i32 @get_sign(i32 noundef %6), !dbg !42
  store i32 %7, i32* %3, align 4, !dbg !43
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %4, metadata !44, metadata !DIExpression()), !dbg !107
  %8 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)), !dbg !108
  store %struct._IO_FILE* %8, %struct._IO_FILE** %4, align 8, !dbg !107
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %4, align 8, !dbg !109
  %10 = icmp ne %struct._IO_FILE* %9, null, !dbg !109
  br i1 %10, label %13, label %11, !dbg !111

11:                                               ; preds = %0
  %12 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.4, i64 0, i64 0)), !dbg !112
  store i32 1, i32* %1, align 4, !dbg !114
  br label %19, !dbg !114

13:                                               ; preds = %0
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** %4, align 8, !dbg !115
  %15 = load i32, i32* %2, align 4, !dbg !116
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %14, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 noundef %15), !dbg !117
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** %4, align 8, !dbg !118
  %18 = call i32 @fclose(%struct._IO_FILE* noundef %17), !dbg !119
  store i32 0, i32* %1, align 4, !dbg !120
  br label %19, !dbg !120

19:                                               ; preds = %13, %11
  %20 = load i32, i32* %1, align 4, !dbg !121
  ret i32 %20, !dbg !121
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "9f715d879ba16174e567f67d0433a7d7")
