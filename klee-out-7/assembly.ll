...
define dso_local i32 @main() #0 !dbg !273 {
  ...
  %7 = load i32, i32* %2, align 4, !dbg !285
  %8 = call i32 @get_sign(i32 noundef %7), !dbg !286
  store i32 %8, i32* %4, align 4, !dbg !287
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !288
  %10 = load i32, i32* %2, align 4, !dbg !289
  %11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %9, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.12, i64 0, i64 0), i32 noundef %10), !dbg !290
  %12 = bitcast i32* %4 to i8*, !dbg !291
  call void @saveFile(i8* noundef %12, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.14, i64 0, i64 0)), !dbg !292
  ret i32 0, !dbg !293
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "33b465f6ad61f70abcda402bba24c711")
!2 = !{!3, !4, !6, !8, !10}
...
!283 = !DILocalVariable(name: "result", scope: !273, file: !1, line: 61, type: !11)
!284 = !DILocation(line: 61, column: 9, scope: !273)
!285 = !DILocation(line: 62, column: 23, scope: !273)
!286 = !DILocation(line: 62, column: 14, scope: !273)
!287 = !DILocation(line: 62, column: 12, scope: !273)
!288 = !DILocation(line: 63, column: 13, scope: !273)
!289 = !DILocation(line: 63, column: 32, scope: !273)
!290 = !DILocation(line: 63, column: 5, scope: !273)
