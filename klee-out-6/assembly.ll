...
@.str.11 = private unnamed_addr constant [19 x i8] c"get_sign.input.txt\00", align 1
...
define dso_local i32 @main() #0 !dbg !273 {
  ...
  %5 = bitcast i32* %2 to i8*, !dbg !278
  call void @klee_make_symbolic(i8* noundef %5, i64 noundef 4, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i64 0, i64 0)), !dbg !279
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %3, metadata !280, metadata !DIExpression()), !dbg !281
  %6 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.11, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)), !dbg !282
  store %struct._IO_FILE* %6, %struct._IO_FILE** %3, align 8, !dbg !281
  %7 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !283
  %8 = load i32, i32* %2, align 4, !dbg !284
  %9 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %7, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.9, i64 0, i64 0), i32 noundef %8), !dbg !285
  call void @llvm.dbg.declare(metadata i32* %4, metadata !286, metadata !DIExpression()), !dbg !287
  %10 = load i32, i32* %2, align 4, !dbg !288
  %11 = call i32 @get_sign(i32 noundef %10), !dbg !289
  store i32 %11, i32* %4, align 4, !dbg !290
  %12 = bitcast i32* %4 to i8*, !dbg !291
  call void @saveFile(i8* noundef %12, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.12, i64 0, i64 0), i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.13, i64 0, i64 0)), !dbg !292
  ret i32 0, !dbg !293
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "1aec6d15428b43cbb8fb50bee0a88da1")
!2 = !{!3, !4, !6, !8, !10}
...
!280 = !DILocalVariable(name: "output_file", scope: !273, file: !1, line: 60, type: !49)
!281 = !DILocation(line: 60, column: 11, scope: !273)
!282 = !DILocation(line: 60, column: 25, scope: !273)
!283 = !DILocation(line: 61, column: 13, scope: !273)
!284 = !DILocation(line: 61, column: 34, scope: !273)
!285 = !DILocation(line: 61, column: 5, scope: !273)
!286 = !DILocalVariable(name: "result", scope: !273, file: !1, line: 62, type: !11)
!287 = !DILocation(line: 62, column: 9, scope: !273)
!288 = !DILocation(line: 63, column: 23, scope: !273)
!289 = !DILocation(line: 63, column: 14, scope: !273)
!290 = !DILocation(line: 63, column: 12, scope: !273)
!291 = !DILocation(line: 64, column: 14, scope: !273)
!292 = !DILocation(line: 64, column: 5, scope: !273)
!293 = !DILocation(line: 65, column: 5, scope: !273)
