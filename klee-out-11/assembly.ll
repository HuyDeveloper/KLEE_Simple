...
@.str.12 = private unnamed_addr constant [20 x i8] c"get_sign.output.txt\00", align 1
@.str.13 = private unnamed_addr constant [19 x i8] c"get_sign.input.txt\00", align 1
...
define dso_local i32 @main() #0 !dbg !273 {
  ...
  %6 = call i32 @get_sign(i32 noundef %5), !dbg !283
  store i32 %6, i32* %3, align 4, !dbg !284
  %7 = bitcast i32* %3 to i8*, !dbg !285
  call void @saveFile(i8* noundef %7, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.12, i64 0, i64 0)), !dbg !286
  %8 = bitcast i32* %2 to i8*, !dbg !287
  call void @saveFile(i8* noundef %8, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.13, i64 0, i64 0)), !dbg !288
  ret i32 0, !dbg !289
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "106de9e89b4188ee15b32e8d5dc3cf72")
!2 = !{!3, !4, !6, !8, !10}
...
!280 = !DILocalVariable(name: "result", scope: !273, file: !1, line: 60, type: !11)
!281 = !DILocation(line: 60, column: 9, scope: !273)
!282 = !DILocation(line: 61, column: 23, scope: !273)
!283 = !DILocation(line: 61, column: 14, scope: !273)
!284 = !DILocation(line: 61, column: 12, scope: !273)
!285 = !DILocation(line: 62, column: 14, scope: !273)
!286 = !DILocation(line: 62, column: 5, scope: !273)
