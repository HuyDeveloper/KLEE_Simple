...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  %5 = load i64, i64* %2, align 8, !dbg !38
  %6 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i64 noundef %5), !dbg !39
  call void @llvm.dbg.declare(metadata i32* %3, metadata !40, metadata !DIExpression()), !dbg !41
  %7 = load i64, i64* %2, align 8, !dbg !42
  %8 = call i32 @get_sign(i64 noundef %7), !dbg !43
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "6ad345aec76efe3c628cd6b2dd1ef36c")
...
!38 = !DILocation(line: 10, column: 21, scope: !31)
!39 = !DILocation(line: 10, column: 5, scope: !31)
!40 = !DILocalVariable(name: "result", scope: !31, file: !1, line: 11, type: !14)
!41 = !DILocation(line: 11, column: 9, scope: !31)
!42 = !DILocation(line: 12, column: 23, scope: !31)
!43 = !DILocation(line: 12, column: 14, scope: !31)
!44 = !DILocation(line: 12, column: 12, scope: !31)
!45 = !DILocation(line: 13, column: 5, scope: !31)
