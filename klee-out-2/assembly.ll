...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  %6 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64 noundef %5), !dbg !39
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "f2e01df5b07376997b4ee01bf48114e4")
...
!38 = !DILocation(line: 10, column: 20, scope: !31)
