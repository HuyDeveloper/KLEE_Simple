...
define dso_local i32 @main() #0 !dbg !273 {
  ...
  %7 = load i32, i32* %3, align 4, !dbg !285
  %8 = sext i32 %7 to i64, !dbg !285
  %9 = inttoptr i64 %8 to i8*, !dbg !285
  call void @saveFile(i8* noundef %9, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.12, i64 0, i64 0)), !dbg !286
  ret i32 0, !dbg !287
}
...
!1 = !DIFile(filename: "generated_code.c", directory: "/home/suyoung02/klee/KLEE_Simple", checksumkind: CSK_MD5, checksum: "883edc58dd71c1fda77b7b084ef28ded")
!2 = !{!3, !4, !6, !8, !10}
...
!287 = !DILocation(line: 63, column: 5, scope: !273)
